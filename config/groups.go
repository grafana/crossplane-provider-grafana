...
var GroupMap = map[string]GroupKindCalculator{
	...
	"grafana_data_source_cache_config":                   ReplaceGroupWords("oss", 0),
	...
	"grafana_apps_secret_keeper_activation_v1beta1":      ReplaceGroupWords("oss", 2),
	"grafana_apps_secret_keeper_v1beta1":                 ReplaceGroupWords("oss", 2),
	"grafana_apps_secret_securevalue_v1beta1":            ReplaceGroupWords("oss", 2),
	"grafana_apps_notifications_inhibitionrule_v0alpha1": ReplaceGroupWords("oss", 2),
