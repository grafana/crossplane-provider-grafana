...
var ExternalNameConfigs = map[string]config.ExternalName{
	...
	"grafana_data_source_permission":            config.IdentifierFromProvider,
	...
	"grafana_role":                              config.IdentifierFromProvider,
	"grafana_role_assignment":                   config.IdentifierFromProvider,
	...
	"grafana_team_external_group":               config.IdentifierFromProvider,
