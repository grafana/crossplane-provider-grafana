...
// SetupWebhookWithManager registers the conversion webhook for DashboardPermission.
func SetupWebhookWithManager(mgr ctrl.Manager) error {
	if err := ctrl.NewWebhookManagedBy(mgr, &v1alpha1.DashboardPermission{}).
		Complete(); err != nil {
...
func SetupGated(mgr ctrl.Manager, o tjcontroller.Options) error {
	o.Options.Gate.Register(func() {
		if err := Setup(mgr, o); err != nil {
			mgr.GetLogger().Error(err, "unable to setup reconciler", "gvk", v1alpha1.DashboardPermission_GroupVersionKind.String())
		}
	}, v1alpha1.DashboardPermission_GroupVersionKind)
	return nil
}
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	eventHandler := handler.NewEventHandler(handler.WithLogger(o.Logger.WithValues("gvk", v1alpha1.DashboardPermission_GroupVersionKind)))
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(
			tjcontroller.NewTerraformPluginFrameworkConnector(mgr.GetClient(), o.SetupFn, o.Provider.Resources["grafana_dashboard_permission"], o.OperationTrackerStore,
				tjcontroller.WithTerraformPluginFrameworkLogger(o.Logger),
				tjcontroller.WithTerraformPluginFrameworkMetricRecorder(metrics.NewMetricRecorder(v1alpha1.DashboardPermission_GroupVersionKind, mgr, o.PollInterval)),
	...
	if o.MetricOptions != nil && o.MetricOptions.MRStateMetrics != nil {
		...
		if err := mgr.Add(stateMetricsRecorder); err != nil {
			return errors.Wrap(err, "cannot register MR state metrics recorder for kind v1alpha1.DashboardPermissionList")
		}
	}
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		Watches(&v1alpha1.DashboardPermission{}, eventHandler).
