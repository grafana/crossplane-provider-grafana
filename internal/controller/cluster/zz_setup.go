...
import (
	...
	collection "github.com/grafana/crossplane-provider-grafana/v2/internal/controller/cluster/agento11y/collection"
	evaluationrule "github.com/grafana/crossplane-provider-grafana/v2/internal/controller/cluster/agento11y/evaluationrule"
	evaluator "github.com/grafana/crossplane-provider-grafana/v2/internal/controller/cluster/agento11y/evaluator"
	hookrule "github.com/grafana/crossplane-provider-grafana/v2/internal/controller/cluster/agento11y/hookrule"
	ruleaction "github.com/grafana/crossplane-provider-grafana/v2/internal/controller/cluster/agento11y/ruleaction"
	...
	inhibitionrulev1beta1 "github.com/grafana/crossplane-provider-grafana/v2/internal/controller/cluster/alerting/inhibitionrulev1beta1"
	...
	routingtreev1beta1 "github.com/grafana/crossplane-provider-grafana/v2/internal/controller/cluster/alerting/routingtreev1beta1"
	rulegroup "github.com/grafana/crossplane-provider-grafana/v2/internal/controller/cluster/alerting/rulegroup"
	rulesequencev0alpha1 "github.com/grafana/crossplane-provider-grafana/v2/internal/controller/cluster/alerting/rulesequencev0alpha1"
	...
	termsacceptance "github.com/grafana/crossplane-provider-grafana/v2/internal/controller/cluster/assistant/termsacceptance"
	...
	componentv1alpha1 "github.com/grafana/crossplane-provider-grafana/v2/internal/controller/cluster/cloud/componentv1alpha1"
	...
	playlistv1 "github.com/grafana/crossplane-provider-grafana/v2/internal/controller/cluster/oss/playlistv1"
	queryv1 "github.com/grafana/crossplane-provider-grafana/v2/internal/controller/cluster/oss/queryv1"
	repositoryv0alpha1 "github.com/grafana/crossplane-provider-grafana/v2/internal/controller/cluster/oss/repositoryv0alpha1"
	resource "github.com/grafana/crossplane-provider-grafana/v2/internal/controller/cluster/oss/resource"
...
func SetupWebhookWithManager(mgr ctrl.Manager) error {
	for _, setup := range []func(ctrl.Manager) error{
		...
		evaluationrule.SetupWebhookWithManager,
		evaluator.SetupWebhookWithManager,
		hookrule.SetupWebhookWithManager,
		ruleaction.SetupWebhookWithManager,
		alertenrichmentv1beta1.SetupWebhookWithManager,
		alertrulev0alpha1.SetupWebhookWithManager,
		contactpoint.SetupWebhookWithManager,
		inhibitionrulev1beta1.SetupWebhookWithManager,
		messagetemplate.SetupWebhookWithManager,
		mutetiming.SetupWebhookWithManager,
		notificationpolicy.SetupWebhookWithManager,
		recordingrulev0alpha1.SetupWebhookWithManager,
		routingtreev1beta1.SetupWebhookWithManager,
		rulegroup.SetupWebhookWithManager,
		rulesequencev0alpha1.SetupWebhookWithManager,
		custommodelrules.SetupWebhookWithManager,
		logconfig.SetupWebhookWithManager,
		notificationalertsconfig.SetupWebhookWithManager,
		profileconfig.SetupWebhookWithManager,
		promrulefile.SetupWebhookWithManager,
		stack.SetupWebhookWithManager,
		suppressedassertionsconfig.SetupWebhookWithManager,
		thresholds.SetupWebhookWithManager,
		traceconfig.SetupWebhookWithManager,
		mcpserver.SetupWebhookWithManager,
		quickstart.SetupWebhookWithManager,
		rule.SetupWebhookWithManager,
		skill.SetupWebhookWithManager,
		termsacceptance.SetupWebhookWithManager,
		accesspolicy.SetupWebhookWithManager,
		accesspolicyrotatingtoken.SetupWebhookWithManager,
		accesspolicytoken.SetupWebhookWithManager,
		appo11yconfigv1alpha1.SetupWebhookWithManager,
		componentv1alpha1.SetupWebhookWithManager,
		dbo11yconfigv1alpha1.SetupWebhookWithManager,
		k8so11yconfigv1alpha1.SetupWebhookWithManager,
		orgmember.SetupWebhookWithManager,
		plugininstallation.SetupWebhookWithManager,
		privatedatasourceconnectnetwork.SetupWebhookWithManager,
		privatedatasourceconnectnetworktoken.SetupWebhookWithManager,
		stackcloud.SetupWebhookWithManager,
		stackserviceaccount.SetupWebhookWithManager,
		stackserviceaccountrotatingtoken.SetupWebhookWithManager,
		stackserviceaccounttoken.SetupWebhookWithManager,
		cloudintegration.SetupWebhookWithManager,
		awsaccount.SetupWebhookWithManager,
		awscloudwatchscrapejob.SetupWebhookWithManager,
		awsresourcemetadatascrapejob.SetupWebhookWithManager,
		azurecredential.SetupWebhookWithManager,
		metricsendpointscrapejob.SetupWebhookWithManager,
		datasourcecacheconfig.SetupWebhookWithManager,
		datasourceconfiglbacrules.SetupWebhookWithManager,
		datasourcepermission.SetupWebhookWithManager,
		datasourcepermissionitem.SetupWebhookWithManager,
		keeperactivationv1beta1.SetupWebhookWithManager,
		keeperv1beta1.SetupWebhookWithManager,
		report.SetupWebhookWithManager,
		role.SetupWebhookWithManager,
		roleassignment.SetupWebhookWithManager,
		roleassignmentitem.SetupWebhookWithManager,
		scimconfig.SetupWebhookWithManager,
		securevaluev1beta1.SetupWebhookWithManager,
		teamexternalgroup.SetupWebhookWithManager,
		collector.SetupWebhookWithManager,
		pipeline.SetupWebhookWithManager,
		app.SetupWebhookWithManager,
		installation.SetupWebhookWithManager,
		loadtest.SetupWebhookWithManager,
		project.SetupWebhookWithManager,
		projectallowedloadzones.SetupWebhookWithManager,
		projectlimits.SetupWebhookWithManager,
		schedule.SetupWebhookWithManager,
		alert.SetupWebhookWithManager,
		holiday.SetupWebhookWithManager,
		job.SetupWebhookWithManager,
		outlierdetector.SetupWebhookWithManager,
		escalation.SetupWebhookWithManager,
		escalationchain.SetupWebhookWithManager,
		integration.SetupWebhookWithManager,
		oncallshift.SetupWebhookWithManager,
		outgoingwebhook.SetupWebhookWithManager,
		route.SetupWebhookWithManager,
		scheduleoncall.SetupWebhookWithManager,
		usernotificationrule.SetupWebhookWithManager,
		annotation.SetupWebhookWithManager,
		connectionv0alpha1.SetupWebhookWithManager,
		dashboard.SetupWebhookWithManager,
		dashboardpermission.SetupWebhookWithManager,
		dashboardpermissionitem.SetupWebhookWithManager,
		dashboardpublic.SetupWebhookWithManager,
		dashboardv1beta1.SetupWebhookWithManager,
		dashboardv2.SetupWebhookWithManager,
		dashboardv2beta1.SetupWebhookWithManager,
		datasource.SetupWebhookWithManager,
		datasourceconfig.SetupWebhookWithManager,
		folder.SetupWebhookWithManager,
		folderpermission.SetupWebhookWithManager,
		folderpermissionitem.SetupWebhookWithManager,
		librarypanel.SetupWebhookWithManager,
		organization.SetupWebhookWithManager,
		organizationpreferences.SetupWebhookWithManager,
		playlist.SetupWebhookWithManager,
		playlistv0alpha1.SetupWebhookWithManager,
		playlistv1.SetupWebhookWithManager,
		queryv1.SetupWebhookWithManager,
		repositoryv0alpha1.SetupWebhookWithManager,
		resource.SetupWebhookWithManager,
		serviceaccount.SetupWebhookWithManager,
		serviceaccountpermission.SetupWebhookWithManager,
		serviceaccountpermissionitem.SetupWebhookWithManager,
		serviceaccountrotatingtoken.SetupWebhookWithManager,
		serviceaccounttoken.SetupWebhookWithManager,
		ssosettings.SetupWebhookWithManager,
		team.SetupWebhookWithManager,
		user.SetupWebhookWithManager,
		providerconfig.SetupWebhookWithManager,
		slo.SetupWebhookWithManager,
		check.SetupWebhookWithManager,
		checkalerts.SetupWebhookWithManager,
		installationsm.SetupWebhookWithManager,
