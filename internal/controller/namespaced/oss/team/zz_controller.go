...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(tjcontroller.NewTerraformPluginSDKConnector(mgr.GetClient(), o.SetupFn, o.Provider.Resources["grafana_team"], o.OperationTrackerStore,
			tjcontroller.WithTerraformPluginSDKLogger(o.Logger),
			tjcontroller.WithTerraformPluginSDKMetricRecorder(metrics.NewMetricRecorder(v1alpha1.Team_GroupVersionKind, mgr, o.PollInterval)),
