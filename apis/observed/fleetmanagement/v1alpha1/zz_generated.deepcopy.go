...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CollectorSetCollectors) DeepCopyInto(out *CollectorSetCollectors) {
	*out = *in
	if in.CollectorType != nil {
		in, out := &in.CollectorType, &out.CollectorType
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CollectorSetCollectors.
func (in *CollectorSetCollectors) DeepCopy() *CollectorSetCollectors {
	if in == nil {
		return nil
	}
	out := new(CollectorSetCollectors)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CollectorSetObservation) DeepCopyInto(out *CollectorSetObservation) {
	*out = *in
	if in.Collectors != nil {
		...
		*out = make([]CollectorSetCollectors, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
