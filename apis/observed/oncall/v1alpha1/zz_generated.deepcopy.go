...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UserSetUsers) DeepCopyInto(out *UserSetUsers) {
	*out = *in
	if in.Email != nil {
		in, out := &in.Email, &out.Email
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UserSetUsers.
func (in *UserSetUsers) DeepCopy() *UserSetUsers {
	if in == nil {
		return nil
	}
	out := new(UserSetUsers)
	in.DeepCopyInto(out)
	return out
}
