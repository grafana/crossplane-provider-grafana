...
type DestinationDatasourceInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	Ref *v1.NamespacedReference `json:"ref,omitempty" tf:"-"`

	// Selector for a DataSource in oss to populate uid.
	// +kubebuilder:validation:Optional
	Selector *v1.NamespacedSelector `json:"selector,omitempty" tf:"-"`
...
type SlowburnEnrichmentInitParameters struct {
...
type SlowburnEnrichmentObservation struct {
...
type SlowburnEnrichmentParameters struct {
...
type SlowburnInitParameters struct {
	...
	Enrichment []SlowburnEnrichmentInitParameters `json:"enrichment,omitempty" tf:"enrichment,omitempty"`
...
type SlowburnObservation struct {
	...
	// (Block List) Enrichments to attach only to Fast Burn alerts. (see below for nested schema)
	// Enrichments to attach only to Slow Burn alerts.
	Enrichment []SlowburnEnrichmentObservation `json:"enrichment,omitempty" tf:"enrichment,omitempty"`
...
type SlowburnParameters struct {
	...
	// Enrichments to attach only to Slow Burn alerts.
	// +kubebuilder:validation:Optional
	Enrichment []SlowburnEnrichmentParameters `json:"enrichment,omitempty" tf:"enrichment,omitempty"`
