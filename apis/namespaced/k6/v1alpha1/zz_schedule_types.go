...
type ScheduleInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/grafana/crossplane-provider-grafana/v2/apis/namespaced/k6/v1alpha1.LoadTest
	...
	// +kubebuilder:validation:Optional
	LoadTestRef *v1.NamespacedReference `json:"loadTestRef,omitempty" tf:"-"`

	// Selector for a LoadTest in k6 to populate loadTestId.
	// +kubebuilder:validation:Optional
	LoadTestSelector *v1.NamespacedSelector `json:"loadTestSelector,omitempty" tf:"-"`
