...
type RealmInitParameters struct {
	...
	// +crossplane:generate:reference:extractor=github.com/grafana/crossplane-provider-grafana/config/namespaced/grafana.ComputedFieldExtractor("id")
	...
	// +kubebuilder:validation:Optional
	StackRef *v1.NamespacedReference `json:"stackRef,omitempty" tf:"-"`

	// Selector for a Stack in cloud to populate identifier.
	// +kubebuilder:validation:Optional
	StackSelector *v1.NamespacedSelector `json:"stackSelector,omitempty" tf:"-"`
