...
type AccessPolicyTokenInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/grafana/crossplane-provider-grafana/apis/namespaced/cloud/v1alpha1.AccessPolicy
	// +crossplane:generate:reference:extractor=github.com/grafana/crossplane-provider-grafana/config/namespaced/grafana.ComputedFieldExtractor("policyId")
