...
func (in *EscalationInitParameters) DeepCopyInto(out *EscalationInitParameters) {
	*out = *in
	...
	if in.GroupToNotifyRef != nil {
		in, out := &in.GroupToNotifyRef, &out.GroupToNotifyRef
		*out = new(v1.NamespacedReference)
		(*in).DeepCopyInto(*out)
	}
	if in.GroupToNotifySelector != nil {
		in, out := &in.GroupToNotifySelector, &out.GroupToNotifySelector
		*out = new(v1.NamespacedSelector)
		(*in).DeepCopyInto(*out)
	}
	if in.Important != nil {
	...
	if in.PersonsToNotifyNextEachTimeRef != nil {
		in, out := &in.PersonsToNotifyNextEachTimeRef, &out.PersonsToNotifyNextEachTimeRef
		*out = make([]v1.NamespacedReference, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.PersonsToNotifyNextEachTimeSelector != nil {
		in, out := &in.PersonsToNotifyNextEachTimeSelector, &out.PersonsToNotifyNextEachTimeSelector
		*out = new(v1.NamespacedSelector)
		(*in).DeepCopyInto(*out)
	}
	if in.PersonsToNotifyRef != nil {
		in, out := &in.PersonsToNotifyRef, &out.PersonsToNotifyRef
		*out = make([]v1.NamespacedReference, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.PersonsToNotifySelector != nil {
		in, out := &in.PersonsToNotifySelector, &out.PersonsToNotifySelector
		*out = new(v1.NamespacedSelector)
		(*in).DeepCopyInto(*out)
	}
	if in.Position != nil {
...
func (in *OutgoingWebhookInitParameters) DeepCopyInto(out *OutgoingWebhookInitParameters) {
	*out = *in
	...
	if in.IntegrationFilterRef != nil {
		in, out := &in.IntegrationFilterRef, &out.IntegrationFilterRef
		*out = make([]v1.NamespacedReference, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.IntegrationFilterSelector != nil {
		in, out := &in.IntegrationFilterSelector, &out.IntegrationFilterSelector
		*out = new(v1.NamespacedSelector)
		(*in).DeepCopyInto(*out)
	}
...
func (in *RouteSlackInitParameters) DeepCopyInto(out *RouteSlackInitParameters) {
	*out = *in
	...
	if in.SlackChannelRef != nil {
		in, out := &in.SlackChannelRef, &out.SlackChannelRef
		*out = new(v1.NamespacedReference)
		(*in).DeepCopyInto(*out)
	}
	if in.SlackChannelSelector != nil {
		in, out := &in.SlackChannelSelector, &out.SlackChannelSelector
		*out = new(v1.NamespacedSelector)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *ScheduleSlackInitParameters) DeepCopyInto(out *ScheduleSlackInitParameters) {
	*out = *in
	...
	if in.SlackUserGroupRef != nil {
		in, out := &in.SlackUserGroupRef, &out.SlackUserGroupRef
		*out = new(v1.NamespacedReference)
		(*in).DeepCopyInto(*out)
	}
	if in.SlackUserGroupSelector != nil {
		in, out := &in.SlackUserGroupSelector, &out.SlackUserGroupSelector
		*out = new(v1.NamespacedSelector)
		(*in).DeepCopyInto(*out)
	}
...
func (in *UserNotificationRuleInitParameters) DeepCopyInto(out *UserNotificationRuleInitParameters) {
	*out = *in
	...
	if in.OnCallUserRef != nil {
		in, out := &in.OnCallUserRef, &out.OnCallUserRef
		*out = new(v1.NamespacedReference)
		(*in).DeepCopyInto(*out)
	}
	if in.OnCallUserSelector != nil {
		in, out := &in.OnCallUserSelector, &out.OnCallUserSelector
		*out = new(v1.NamespacedSelector)
		(*in).DeepCopyInto(*out)
	}
	if in.Position != nil {
