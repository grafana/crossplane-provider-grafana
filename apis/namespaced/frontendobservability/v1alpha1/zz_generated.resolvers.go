...
func (mg *App) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		CurrentValue: reference.FromFloatPtrValue(mg.Spec.ForProvider.StackID),
	...
	mg.Spec.ForProvider.StackID = reference.ToFloatPtrValue(rsp.ResolvedValue)
	mg.Spec.ForProvider.CloudStackRef = rsp.ResolvedReference

	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		CurrentValue: reference.FromFloatPtrValue(mg.Spec.InitProvider.StackID),
		Extract:      grafana.ComputedFieldExtractor("id"),
		Namespace:    mg.GetNamespace(),
	...
	mg.Spec.InitProvider.StackID = reference.ToFloatPtrValue(rsp.ResolvedValue)
