...
// TraceConfigList contains a list of TraceConfigs
type TraceConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []TraceConfig `json:"items"`
}

// Repository type metadata.
var (
	TraceConfig_Kind             = "TraceConfig"
	TraceConfig_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: TraceConfig_Kind}.String()
	TraceConfig_KindAPIVersion   = TraceConfig_Kind + "." + CRDGroupVersion.String()
	TraceConfig_GroupVersionKind = CRDGroupVersion.WithKind(TraceConfig_Kind)
)

func init() {
	SchemeBuilder.Register(&TraceConfig{}, &TraceConfigList{})
}
