...
type NotificationPolicyInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/grafana/crossplane-provider-grafana/apis/namespaced/alerting/v1alpha1.ContactPoint
	// +crossplane:generate:reference:extractor=github.com/grafana/crossplane-provider-grafana/config/namespaced/grafana.FieldExtractor("name")
...
type PolicyInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/grafana/crossplane-provider-grafana/apis/namespaced/alerting/v1alpha1.MuteTiming
	// +crossplane:generate:reference:extractor=github.com/grafana/crossplane-provider-grafana/config/namespaced/grafana.FieldExtractor("name")
