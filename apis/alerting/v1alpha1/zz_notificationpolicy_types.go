...
type NotificationPolicy struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.groupBy) || has(self.initProvider.groupBy)",message="groupBy is a required parameter"
