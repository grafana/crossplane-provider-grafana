...
// Preserve aggregator register files; delete other zz_* generated files.
//go:generate bash -c "find . -iname 'zz_*' ! -iname 'zz_generated.managed*.go' ! -name 'zz_register.go' -delete"
