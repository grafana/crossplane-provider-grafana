...
type InstallationInitParameters struct {
	...
	CloudAccessPolicyTokenSecretRef *v2.SecretKeySelector `json:"cloudAccessPolicyTokenSecretRef,omitempty" tf:"-"`
	...
	GrafanaSaTokenSecretRef v2.SecretKeySelector `json:"grafanaSaTokenSecretRef" tf:"-"`
