...
func (mg *Installation) GetTerraformResourceType() string {
	return "grafana_k6_installation"
}

// GetConnectionDetailsMapping for this Installation
func (tr *Installation) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"cloud_access_policy_token": "cloudAccessPolicyTokenSecretRef", "grafana_sa_token": "grafanaSaTokenSecretRef", "k6_access_token": "status.atProvider.k6AccessToken"}
}
