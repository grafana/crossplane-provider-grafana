...
// GetItems of this Appo11YconfigV1Alpha1List.
func (l *Appo11YconfigV1Alpha1List) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
...
// GetItems of this ComponentV1Alpha1List.
func (l *ComponentV1Alpha1List) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
