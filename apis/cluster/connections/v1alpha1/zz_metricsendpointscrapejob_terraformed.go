...
func (mg *MetricsEndpointScrapeJob) GetTerraformResourceType() string {
	return "grafana_connections_metrics_endpoint_scrape_job"
}
...
func (tr *MetricsEndpointScrapeJob) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"authentication_basic_password": "authenticationBasicPasswordSecretRef", "authentication_bearer_token": "authenticationBearerTokenSecretRef"}
}
...
// LateInitialize this MetricsEndpointScrapeJob using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *MetricsEndpointScrapeJob) LateInitialize(attrs []byte) (bool, error) {
	params := &MetricsEndpointScrapeJobParameters{}
