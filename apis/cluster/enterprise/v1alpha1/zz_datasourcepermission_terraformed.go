...
func (mg *DataSourcePermission) GetTerraformResourceType() string {
	return "grafana_data_source_permission"
}
...
// LateInitialize this DataSourcePermission using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *DataSourcePermission) LateInitialize(attrs []byte) (bool, error) {
	params := &DataSourcePermissionParameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
	opts = append(opts, resource.WithNameFilter("OrgID"))
	opts = append(opts, resource.WithNameFilter("Permissions.TeamID"))
	opts = append(opts, resource.WithNameFilter("Permissions.UserID"))
