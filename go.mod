...
require (
	...
	github.com/grafana/terraform-provider-grafana/v4 v4.5.0
...
require (
	...
	github.com/grafana/grafana-asserts-public-clients/go/gcom v0.0.0-20250805165836-14e16b51b910 // indirect
