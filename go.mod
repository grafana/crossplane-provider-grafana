...
require (
	...
	github.com/grafana/terraform-provider-grafana/v4 v4.13.0
...
require (
	...
	github.com/grafana/grafana-asserts-public-clients/go/gcom v0.0.0-20251014094449-86b1bd3db812 // indirect
